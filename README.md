...
| Component                    | Version                                                                                           |
|------------------------------|---------------------------------------------------------------------------------------------------|
| CodeFlare Operator           | [v0.0.8](https://github.com/project-codeflare/codeflare-operator/releases/tag/v0.0.8)             |
...
| CodeFlare-SDK                | [v0.0.6](https://github.com/project-codeflare/codeflare-sdk/releases/tag/v0.0.6)                  |
| InstaScale                   | [v0.0.6](https://github.com/project-codeflare/instascale/releases/tag/v0.0.6)                     |
