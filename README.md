...
| Component                    | Version                                                                                           |
|------------------------------|---------------------------------------------------------------------------------------------------|
| CodeFlare Operator           | [v1.0.0-rc.2-rc.1](https://github.com/project-codeflare/codeflare-operator/releases/tag/v1.0.0-rc.2-rc.1)             |
| Multi-Cluster App Dispatcher | [v1.34.0](https://github.com/project-codeflare/multi-cluster-app-dispatcher/releases/tag/v1.34.0) |
| CodeFlare-SDK                | [v0.7.0](https://github.com/project-codeflare/codeflare-sdk/releases/tag/v0.7.0)                  |
