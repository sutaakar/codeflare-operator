...
| Component                    | Version                                                                                           |
|------------------------------|---------------------------------------------------------------------------------------------------|
| CodeFlare Operator           | [v1.0.2](https://github.com/project-codeflare/codeflare-operator/releases/tag/v1.0.2)             |
...
| CodeFlare-SDK                | [v0.12.0](https://github.com/project-codeflare/codeflare-sdk/releases/tag/v0.12.0)                  |
| InstaScale                   | [v0.3.0](https://github.com/project-codeflare/instascale/releases/tag/v0.3.0)                     |
| KubeRay                      | [v1.0.0-rc.1](https://github.com/opendatahub-io/kuberay/releases/tag/v1.0.0-rc.1)                              |
